...
<#
.Synopsis
   This PowerShell is for custom detection in Microsoft MEM for Dell Support Assist for Business PC

.DESCRIPTION
   This PowerShell will checki if Dell Support Assist for Business PC is ready installed on a device. It will be used as custom detection in Microsoft MEM win32 install.
