...
<#
.Synopsis
   This PowerShell is for uninstall in Microsoft MEM for Dell Command | Monitor

.DESCRIPTION
   This PowerShell will uninstall a Device for Dell Command | Monitor. It will be used as install file in Microsoft MEM win32 install.
