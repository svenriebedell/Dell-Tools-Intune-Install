...
<#
.Synopsis
   This PowerShell is for uninstall Microsoft ASP .net 8.x runtime by Intune

.DESCRIPTION
   This PowerShell will uninstall Microsoft ASP .net 8.x on the device. It will be used as install file in Microsoft MEM win32 install.
...
$AppSearch = "Microsoft*ASP*Core*8*(x64)*" #Parameter to search in registry
